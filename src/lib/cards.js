export const cards = [
  {
    id: 1,
    name: "The Cage with Wings",
    byeline: "When I sleep, my mother arranges the universe.",
    description:
  ...
  },
  {
    id: 2,
    name: "The Tower",
    byeline: '"Hermetically sealed the tower advises those within."',
    description:
  ...
  },
  {
    id: 3,
    name: "The Knight",
    byeline: '"Hermetically inside me, you are safe as the enemy is me."',
    description:
  ...
  },
  {
    id: 4,
    name: "The Clock",
    byeline: '"The power of serenity is the clandestine and the underworld."',
    description:
  ...
  },
  {
    id: 5,
    name: "The Obelisk",
    byeline: '"The internalized self and the values which define."',
    description:
  ...
  },
  {
    id: 6,
    name: "The Bowl",
    byeline: '"Who is nostalgic of the present?"',
    description:
  ...
  },
  {
    ...
    byeline: '"Licking my wounds, I taste the iron in the blood."',
    description:
  ...
  },
  {
    ...
    name: "Mr. Diamond",
    byeline:
      '"I have a lifetime in front of me. Do you want to keep me company?"',
    description:
  ...
  },
  {
    ...
    byeline:
      '"Somewhere in the distance, the hidden secret calls for me to find it."',
    description:
  ...
  },
  {
    ...
    byeline: '"Honoring each other, we will have a good time."',
    description:
  ...
  },
  {
    ...
    byeline: '"The lost key calls for you to find it."',
    description:
  ...
  },
  {
    ...
    byeline: '"Eros and Irritation dance a passionate tango."',
    description:
  ...
  },
  {
    id: 13,
    name: "Queen Bee",
    byeline: '"The tender care grows from her devotion"',
    description:
  ...
  },
  {
    ...
    name: "The Amazon",
    byeline:
      '"When the game becomes the leader, it becomes endless, and celebration is the victory."',
    description:
  ...
  },
  {
    id: 15,
    name: "Athena",
    byeline: '"In the Map meets the present, the past and the future."',
    description:
  ...
  },
  {
    id: 16,
    name: "Lucidity",
    byeline: '"In the space-time truth is only one."',
    description:
  ...
  {
    id: 17,
    name: "The Dragon Princess",
    byeline: '"I was already a dragon when St. George came."',
    description:
  ...
  {
    id: 18,
    name: "The Big and The Little Dipper",
    byeline: '"When we walk together, our aura is happy and blessed."',
    description:
  ...
  },
  {
    id: 19,
    name: "Gravity",
    byeline: '"I sink into the depths of a dark ablyssof nonexistence."',
    description:
  ...
  {
    id: 20,
    name: "The Deer Goddess",
    byeline: '"But if I stop dancing the world will fall."',
    description:
  ...
  {
    id: 21,
    name: "The Defeated Victory",
    byeline: '"Consolation is a gift of positive energy."',
    description:
  ...
  },
  {
    ...
    name: "Diamonite",
    byeline:
      '"When we met in my dream, you told me that you shine from the interior light of matter."',
    description:
  ...
  },
  {
    ...
    byeline: '"Every child that is born has the age of the universe."',
    description:
...
export const spreadPositions = [
  {
    name: "Past",
    description:
      "The foundational influences or events that led to the present situation.",
  },
  {
    name: "Present",
    description: "The current state of the situation, the core of the issue.",
  },
  {
    name: "Future",
    description:
      "What is the most probable outcome if things continue on their current path?",
  },
  {
    name: "Root Cause",
    description:
      "What is the hidden or core reason for the current circumstances?",
  },
  {
    name: "Potential",
    description:
      "What is the ultimate potential or possible resolution of the situation?",
  },
];
